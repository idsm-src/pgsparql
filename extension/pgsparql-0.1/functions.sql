-- functional forms
CREATE FUNCTION same_term_rdfbox(rdfbox,rdfbox) RETURNS bool AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;

-- functions on RDF terms
CREATE SEQUENCE query_blanknode;
CREATE FUNCTION is_bound(anyelement) RETURNS bool AS $$ SELECT CASE WHEN $1 IS NOT NULL THEN true ELSE NULL END $$ LANGUAGE SQL IMMUTABLE PARALLEL SAFE STRICT;
...
CREATE FUNCTION bnode() RETURNS int8 AS $$ select nextval('query_blanknode') % (2^32)::int8; $$ LANGUAGE SQL VOLATILE PARALLEL SAFE STRICT;
CREATE FUNCTION uuid() RETURNS varchar AS $$ select 'urn:uuid:' || uuid_generate_v4(); $$ LANGUAGE SQL VOLATILE PARALLEL SAFE STRICT;
CREATE FUNCTION struuid() RETURNS varchar AS $$ select uuid_generate_v4()::varchar; $$ LANGUAGE SQL VOLATILE PARALLEL SAFE STRICT;
...
CREATE FUNCTION ucase_string(varchar) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION ucase_rdfbox(rdfbox) RETURNS rdfbox AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION lcase_string(varchar) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
...
CREATE FUNCTION concat_string_string(varchar,varchar) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
...
CREATE FUNCTION abs_float(float4) RETURNS float4 AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION abs_double(float8) RETURNS float8 AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION abs_integer(decimal) RETURNS decimal AS 'MODULE_PATHNAME','abs_decimal' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION abs_decimal(decimal) RETURNS decimal AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION abs_rdfbox(rdfbox) RETURNS rdfbox AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION round_float(float4) RETURNS float4 AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION round_double(float8) RETURNS float8 AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION round_decimal(decimal) RETURNS decimal AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION round_rdfbox(rdfbox) RETURNS rdfbox AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION ceil_float(float4) RETURNS float4 AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION ceil_double(float8) RETURNS float8 AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION ceil_decimal(decimal) RETURNS decimal AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION ceil_rdfbox(rdfbox) RETURNS rdfbox AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION floor_float(float4) RETURNS float4 AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION floor_double(float8) RETURNS float8 AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION floor_decimal(decimal) RETURNS decimal AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION floor_rdfbox(rdfbox) RETURNS rdfbox AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rand() RETURNS float8 AS $$ select random(); $$ LANGUAGE SQL VOLATILE PARALLEL SAFE STRICT;
...
-- hash functions
CREATE FUNCTION md5_string(varchar) RETURNS varchar AS $$ select substring(digest($1,'md5')::varchar from 3); $$ LANGUAGE SQL IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION sha1_string(varchar) RETURNS varchar AS $$ select substring(digest($1,'sha1')::varchar from 3); $$ LANGUAGE SQL IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION sha256_string(varchar) RETURNS varchar AS $$ select substring(digest($1,'sha256')::varchar from 3); $$ LANGUAGE SQL IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION sha384_string(varchar) RETURNS varchar AS $$ select substring(digest($1,'sha384')::varchar from 3); $$ LANGUAGE SQL IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION sha512_string(varchar) RETURNS varchar AS $$ select substring(digest($1,'sha512')::varchar from 3); $$ LANGUAGE SQL IMMUTABLE PARALLEL SAFE STRICT;
