...
CREATE FUNCTION cast_as_datetime_from_date(date,int4) RETURNS zoneddatetime AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE STRICT;
...
CREATE FUNCTION cast_as_string_from_integer(decimal) RETURNS varchar AS 'MODULE_PATHNAME','cast_as_string_from_decimal' LANGUAGE C IMMUTABLE STRICT;
...
CREATE FUNCTION cast_as_string_from_datetime(timestamptz,int4) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE STRICT;
CREATE FUNCTION cast_as_string_from_date(zoneddate) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE STRICT;
CREATE FUNCTION cast_as_string_from_date(date,int4) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE STRICT;
...
CREATE FUNCTION cast_as_rdfbox_from_datetime(timestamptz,int4) RETURNS rdfbox AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE STRICT;
CREATE FUNCTION cast_as_rdfbox_from_date(zoneddate) RETURNS rdfbox AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE STRICT;
CREATE FUNCTION cast_as_rdfbox_from_date(date,int4) RETURNS rdfbox AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE STRICT;
