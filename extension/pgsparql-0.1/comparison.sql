...
CREATE FUNCTION equal_datetime(timestamptz,int4,timestamptz,int4) RETURNS bool AS $$ select $1 = $3; $$ LANGUAGE SQL IMMUTABLE STRICT;
CREATE FUNCTION equal_date(zoneddate,zoneddate) RETURNS bool AS $$ select $1 operator(sparql.=) $2; $$ LANGUAGE SQL IMMUTABLE STRICT;
CREATE FUNCTION equal_date(date,int4,date,int4) RETURNS bool AS $$ select $1 = $3; $$ LANGUAGE SQL IMMUTABLE STRICT;
...
CREATE FUNCTION equal_lang_string(varchar,varchar,varchar,varchar) RETURNS bool AS $$ select $1 = $3 and $2 = $4; $$ LANGUAGE SQL IMMUTABLE STRICT;
CREATE FUNCTION equal_typed_literal(varchar,varchar,varchar,varchar) RETURNS bool AS $$ select nullif($1 = $3 and $2 = $4, false); $$ LANGUAGE SQL IMMUTABLE STRICT;
...
CREATE FUNCTION not_equal_datetime(timestamptz,int4,timestamptz,int4) RETURNS bool AS $$ select $1 != $3; $$ LANGUAGE SQL IMMUTABLE STRICT;
...
CREATE FUNCTION not_equal_date(date,int4,date,int4) RETURNS bool AS $$ select $1 != $3; $$ LANGUAGE SQL IMMUTABLE STRICT;
...
CREATE FUNCTION not_equal_lang_string(varchar,varchar,varchar,varchar) RETURNS bool AS $$ select $1 != $3 or $2 != $4; $$ LANGUAGE SQL IMMUTABLE STRICT;
CREATE FUNCTION not_equal_typed_literal(varchar,varchar,varchar,varchar) RETURNS bool AS $$ select nullif($1 != $3 or $2 != $4, true); $$ LANGUAGE SQL IMMUTABLE STRICT;
...
CREATE FUNCTION less_than_datetime(timestamptz,int4,timestamptz,int4) RETURNS bool AS $$ select $1 < $3; $$ LANGUAGE SQL IMMUTABLE STRICT;
...
CREATE FUNCTION less_than_date(date,int4,date,int4) RETURNS bool AS $$ select $1 < $3; $$ LANGUAGE SQL IMMUTABLE STRICT;
...
CREATE FUNCTION greater_than_datetime(timestamptz,int4,timestamptz,int4) RETURNS bool AS $$ select $1 > $3; $$ LANGUAGE SQL IMMUTABLE STRICT;
...
CREATE FUNCTION greater_than_date(date,int4,date,int4) RETURNS bool AS $$ select $1 > $3; $$ LANGUAGE SQL IMMUTABLE STRICT;
...
CREATE FUNCTION not_less_than_datetime(timestamptz,int4,timestamptz,int4) RETURNS bool AS $$ select $1 >= $3; $$ LANGUAGE SQL IMMUTABLE STRICT;
...
CREATE FUNCTION not_less_than_date(date,int4,date,int4) RETURNS bool AS $$ select $1 >= $3; $$ LANGUAGE SQL IMMUTABLE STRICT;
...
CREATE FUNCTION not_greater_than_datetime(timestamptz,int4,timestamptz,int4) RETURNS bool AS $$ select $1 <= $3; $$ LANGUAGE SQL IMMUTABLE STRICT;
...
CREATE FUNCTION not_greater_than_date(date,int4,date,int4) RETURNS bool AS $$ select $1 <= $3; $$ LANGUAGE SQL IMMUTABLE STRICT;
