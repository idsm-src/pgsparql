...
CREATE FUNCTION rdfbox_input(cstring) RETURNS rdfbox  AS 'MODULE_PATHNAME' LANGUAGE C STABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_output(rdfbox) RETURNS cstring AS 'MODULE_PATHNAME' LANGUAGE C STABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_recv(internal) RETURNS rdfbox AS 'MODULE_PATHNAME' LANGUAGE C STABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_send(rdfbox) RETURNS bytea AS 'MODULE_PATHNAME' LANGUAGE C PARALLEL SAFE STABLE STRICT;
...
CREATE FUNCTION rdfbox_create_from_byte(int2) RETURNS rdfbox AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_create_from_byte_with_lexical(int2,varchar) RETURNS rdfbox AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_create_from_unsignedbyte(int2) RETURNS rdfbox AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_create_from_unsignedbyte_with_lexical(int2,varchar) RETURNS rdfbox AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
...
CREATE FUNCTION rdfbox_create_from_unsignedshort(int4) RETURNS rdfbox AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_create_from_unsignedshort_with_lexical(int4,varchar) RETURNS rdfbox AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
...
CREATE FUNCTION rdfbox_create_from_unsignedint(int8) RETURNS rdfbox AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_create_from_unsignedint_with_lexical(int8,varchar) RETURNS rdfbox AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
...
CREATE FUNCTION rdfbox_create_from_unsignedlong(decimal) RETURNS rdfbox AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_create_from_unsignedlong_with_lexical(decimal,varchar) RETURNS rdfbox AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
...
CREATE FUNCTION rdfbox_create_from_nonpositiveinteger(decimal) RETURNS rdfbox AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_create_from_nonpositiveinteger_with_lexical(decimal,varchar) RETURNS rdfbox AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_create_from_negativeinteger(decimal) RETURNS rdfbox AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_create_from_negativeinteger_with_lexical(decimal,varchar) RETURNS rdfbox AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_create_from_nonnegativeinteger(decimal) RETURNS rdfbox AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_create_from_nonnegativeinteger_with_lexical(decimal,varchar) RETURNS rdfbox AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_create_from_positiveinteger(decimal) RETURNS rdfbox AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_create_from_positiveinteger_with_lexical(decimal,varchar) RETURNS rdfbox AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
...
CREATE FUNCTION rdfbox_create_from_userliteral_with_lexical(ubox,varchar,varchar) RETURNS rdfbox AS 'MODULE_PATHNAME','rdfbox_create_from_boxed_userliteral_with_lexical' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
...
CREATE FUNCTION rdfbox_get_byte(rdfbox) RETURNS int2 AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_byte(rdfbox,bool) RETURNS int2 AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_byte_lexical(rdfbox) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_byte_lexical(rdfbox,bool) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_unsignedbyte(rdfbox) RETURNS int2 AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_unsignedbyte(rdfbox,bool) RETURNS int2 AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_unsignedbyte_lexical(rdfbox) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_unsignedbyte_lexical(rdfbox,bool) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
...
CREATE FUNCTION rdfbox_get_unsignedshort(rdfbox) RETURNS int4 AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_unsignedshort(rdfbox,bool) RETURNS int4 AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_unsignedshort_lexical(rdfbox) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_unsignedshort_lexical(rdfbox,bool) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
...
CREATE FUNCTION rdfbox_get_unsignedint(rdfbox) RETURNS int8 AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_unsignedint(rdfbox,bool) RETURNS int8 AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_unsignedint_lexical(rdfbox) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_unsignedint_lexical(rdfbox,bool) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
...
CREATE FUNCTION rdfbox_get_unsignedlong(rdfbox) RETURNS decimal AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_unsignedlong(rdfbox,bool) RETURNS decimal AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_unsignedlong_lexical(rdfbox) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_unsignedlong_lexical(rdfbox,bool) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
...
CREATE FUNCTION rdfbox_get_nonpositiveinteger(rdfbox) RETURNS decimal AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_nonpositiveinteger(rdfbox,bool) RETURNS decimal AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_nonpositiveinteger_lexical(rdfbox) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_nonpositiveinteger_lexical(rdfbox,bool) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_negativeinteger(rdfbox) RETURNS decimal AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_negativeinteger(rdfbox,bool) RETURNS decimal AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_negativeinteger_lexical(rdfbox) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_negativeinteger_lexical(rdfbox,bool) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_nonnegativeinteger(rdfbox) RETURNS decimal AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_nonnegativeinteger(rdfbox,bool) RETURNS decimal AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_nonnegativeinteger_lexical(rdfbox) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_nonnegativeinteger_lexical(rdfbox,bool) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_positiveinteger(rdfbox) RETURNS decimal AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_positiveinteger(rdfbox,bool) RETURNS decimal AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_positiveinteger_lexical(rdfbox) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_positiveinteger_lexical(rdfbox,bool) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
...
CREATE FUNCTION rdfbox_get_datetime_lexical_of_zone(rdfbox,int4) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_datetime_lexical_of_zone(rdfbox,int4,bool) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
...
CREATE FUNCTION rdfbox_get_date_lexical_of_zone(rdfbox,int4) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_date_lexical_of_zone(rdfbox,int4,bool) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
...
CREATE FUNCTION rdfbox_get_userliteral_value_of_type(rdfbox,varchar,bool) RETURNS ubox AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_userliteral_typedvalue_of_type(rdfbox,varchar,anyelement) RETURNS anyelement AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE;
CREATE FUNCTION rdfbox_get_userliteral_typedvalue_of_type(rdfbox,varchar,anyelement,bool) RETURNS anyelement AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE;
CREATE FUNCTION rdfbox_get_userliteral_type(rdfbox) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_userliteral_type(rdfbox,bool) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_userliteral_lexical(rdfbox) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_userliteral_lexical(rdfbox,bool) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_userliteral_lexical_of_type(rdfbox,varchar) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION rdfbox_get_userliteral_lexical_of_type(rdfbox,varchar,bool) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
