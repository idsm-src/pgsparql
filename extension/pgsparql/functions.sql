...
CREATE FUNCTION str_boolean(bool) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION str_byte(int2) RETURNS varchar AS 'MODULE_PATHNAME','str_short' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION str_unsignedbyte(int2) RETURNS varchar AS 'MODULE_PATHNAME','str_short' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION str_short(int2) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION str_unsignedshort(int4) RETURNS varchar AS 'MODULE_PATHNAME','str_int' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION str_int(int4) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION str_unsignedint(int8) RETURNS varchar AS 'MODULE_PATHNAME','str_long' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION str_long(int8) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION str_unsignedlong(decimal) RETURNS varchar AS 'MODULE_PATHNAME','str_integer' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION str_integer(decimal) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION str_nonpositiveinteger(decimal) RETURNS varchar AS 'MODULE_PATHNAME','str_integer' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION str_negativeinteger(decimal) RETURNS varchar AS 'MODULE_PATHNAME','str_integer' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION str_nonnegativeinteger(decimal) RETURNS varchar AS 'MODULE_PATHNAME','str_integer' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION str_positiveinteger(decimal) RETURNS varchar AS 'MODULE_PATHNAME','str_integer' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION str_decimal(decimal) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION str_float(float4) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION str_double(float8) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION str_datetime(zoneddatetime) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION str_datetime(timestamptz,int4) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION str_date(zoneddate) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION str_date(date,int4) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION str_daytimeduration(int8) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C IMMUTABLE PARALLEL SAFE STRICT;
CREATE FUNCTION str_rdfbox(rdfbox) RETURNS varchar AS 'MODULE_PATHNAME' LANGUAGE C STABLE PARALLEL SAFE STRICT;
