...
PG_FUNCTION_INFO_V1(sub_float);
Datum sub_float(PG_FUNCTION_ARGS)
{
...
PG_FUNCTION_INFO_V1(sub_double);
Datum sub_double(PG_FUNCTION_ARGS)
{
...
PG_FUNCTION_INFO_V1(sub_decimal);
Datum sub_decimal(PG_FUNCTION_ARGS)
{
    Numeric left = PG_GETARG_NUMERIC(0);
    Numeric right = PG_GETARG_NUMERIC(1);

    Datum result = DirectFunctionCall2(numeric_sub, NumericGetDatum(left), NumericGetDatum(right));
...
PG_FUNCTION_INFO_V1(sub_rdfbox);
Datum sub_rdfbox(PG_FUNCTION_ARGS)
{
