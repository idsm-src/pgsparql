...
static inline int copy_special_str(char * const result, const bool sign, const bool exponent, const bool mantissa, const bool scientific) {
  if (mantissa) {
    memcpy(result, "NaN", 3);
    return 3;
  }
