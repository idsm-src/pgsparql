...
PG_FUNCTION_INFO_V1(cast_as_float_from_integer);
Datum cast_as_float_from_integer(PG_FUNCTION_ARGS)
{
    ...
    PG_TRY_EX();
    {
        result = DirectFunctionCall1(numeric_float4, NumericGetDatum(value));
    }
    PG_CATCH_EX();
    {
...
Datum cast_as_float_from_rdfbox(PG_FUNCTION_ARGS)
{
    ...
    {
        case XSD_BOOLEAN:
            result = DirectFunctionCall1(cast_as_float_from_boolean, BoolGetDatum(((RdfBoxBoolean *) box)->value));
            break;

        case XSD_SHORT:
            result = DirectFunctionCall1(cast_as_float_from_short, Int16GetDatum(((RdfBoxShort *) box)->value));
            break;

        case XSD_INT:
            result = DirectFunctionCall1(cast_as_float_from_int, Int32GetDatum(((RdfBoxInt *) box)->value));
            break;

        case XSD_LONG:
            result = DirectFunctionCall1(cast_as_float_from_long, Int64GetDatum(((RdfBoxLong *) box)->value));
            break;

        case XSD_FLOAT:
            result = Float4GetDatum(((RdfBoxFloat *) box)->value);
            break;

        case XSD_DOUBLE:
            result = DirectFunctionCall1(cast_as_float_from_double, Float8GetDatum(((RdfBoxDouble *) box)->value));
            break;

        case XSD_INTEGER:
            result = DirectFunctionCall1(cast_as_float_from_integer, NumericGetDatum(((RdfBoxInteger *) box)->value));
            break;

        case XSD_DECIMAL:
            result = DirectFunctionCall1(cast_as_float_from_decimal, NumericGetDatum(((RdfBoxDecinal *) box)->value));
            break;

        case XSD_STRING:
            result = DirectFunctionCall1(cast_as_float_from_string, PointerGetDatum(((RdfBoxString *) box)->value));
            break;
