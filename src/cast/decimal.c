...
Datum cast_as_decimal_from_rdfbox(PG_FUNCTION_ARGS)
{
    ...
    switch(box->type)
    {
        ...
        case XSD_FLOAT:
            result = NullableFunctionCall1(cast_as_decimal_from_float, Float4GetDatum(((RdfBoxFloat *) box)->value));
            break;

        case XSD_DOUBLE:
            result = NullableFunctionCall1(cast_as_decimal_from_double, Float8GetDatum(((RdfBoxDouble *) box)->value));
            break;
        ...
        case XSD_STRING:
            result = NullableFunctionCall1(cast_as_decimal_from_string, PointerGetDatum(((RdfBoxString *) box)->value));
            break;
